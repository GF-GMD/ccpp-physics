...
!   use gsd_chem_prep,   only : gsd_chem_prep_rad
   use gsd_chem_config
!   use dep_dry_mod
!   use dep_wet_ls_mod
...
!> @{
    subroutine gsd_chem_rad_wrapper_run(im, kte, kme, ktau, dt, garea, land, &
                   u10m, v10m, ustar, rlat, rlon, tskin,julian,   &
...
!   print*,'GSD vegtype,soiltyp,sigmaf',vegtype,soiltyp,sigmaf
    call gsd_chem_prep_rad(                                             &
        readrestart,chem_in_opt,ktau,dtstep,                     &
